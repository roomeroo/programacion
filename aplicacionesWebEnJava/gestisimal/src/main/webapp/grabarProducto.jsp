...
<html>
    ...
    <body>
        <%
            ...
            // Crear socio a través del gestor (esta operación puede generar excepciones que hay que controlar)
            ...
            Producto socio = new Producto(codigo, descripcion, precioCompra, precioVenta, stock);
            try{
                if(gestor.create(socio)){
                    out.println("todo bien");
                }else{
                    throw new Exception("Error. Producto no creado.");
                }
            }catch(Exception ex){
